...
\subsection{Relation Fréquence vs Montant}
...
\begin{figure}[H]
    ...
    \caption{Corrélation entre fréquence d'achat et montant total}
\end{figure}

\subsection{Distribution des Segments RFM Initiaux}
...
\begin{figure}[H]
    ...
    \caption{Répartition des clients par segment RFM}
\end{figure}
