...
\vspace{2cm}
{\large \textbf{Préparé par : [Votre Nom]}}
\vspace{3cm}
...
\subsection{Valeurs Suspectes et Codes Erreurs}
...
\begin{itemize}[label=\color{accentorange}$\triangle$]
    \item Valeurs numériques suspectes : \textbf{-1, 99, 999}.
    \item Valeurs textuelles invalides : \textbf{"Unknown", "NA", ""}.
    \item \textit{Exemple :} La colonne \textit{MinQuantity} contient des valeurs négatives (-1) correspondant probablement à des retours ou erreurs système.
\end{itemize}
